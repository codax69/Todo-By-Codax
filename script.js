...
function filterTodo(e) {   //run function with e parameter
    ...
    for (let i = 0; i < todos.length; i++) { // run for loop
        const todo = todos[i];    //create todo variable and print todos[i]

        if (todo.classList.contains(filterValue)) {  // use if else statement 
